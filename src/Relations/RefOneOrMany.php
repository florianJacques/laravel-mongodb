 ...
 */
abstract class RefOneOrMany extends Relation
{
    use InteractsWithDictionary, SupportsInverseRelations, InteractsWithBson;
     ...
     */
    public function __construct(Builder $query, Model $parent, $referenceType, $foreignKey, $localKey)
    {
    ...
    public function addConstraints()
    {
        if (static::$constraints) {
            ...
            $query->where($this->foreignKey, '=', $this->getReference($this->getParentKey()));
    ...
    public function upsert(array $values, $uniqueBy, $update = null)
    {
        ...
        foreach ($values as $key => $value) {
            $values[$key][$this->getForeignKeyName()] = $this->getReference($this->getParentKey());
        }
    ...
    {
        $model->setAttribute($this->getForeignKeyName(), $this->getReference($this->getParentKey()));
