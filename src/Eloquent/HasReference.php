...
use MongoDB\Laravel\Relations\RefToMany;
...
trait HasReference
{
    ...
    public function refToMany($related, $referenceType = null, $foreignKey = null, $ownerKey = null, $relation = null)
    {
        // If no relation name was given, we will use this debug backtrace to extract
        // the calling method's name and use that as the relationship name as most
        // of the time this will be what we desire to use for the relationships.
        ...
        return new RefToMany($query, $this, $referenceType, $foreignKey, $ownerKey, $relation);
    }
}
